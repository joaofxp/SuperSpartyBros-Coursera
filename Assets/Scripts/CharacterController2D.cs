...
public class CharacterController2D : MonoBehaviour {
	...
	void Update()
	{
		...
		// whatIsGround layer
		_Grounded = Physics2D.Linecast(_transform.position, groundCheck.position, whatIsGround);
		...
		if(_Grounded && CrossPlatformInputManager.GetButtonDown("Jump")) // If grounded AND jump button pressed, then allow the player to jump
		{
            DoJump();
